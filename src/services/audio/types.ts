...
export const audioCommandCopies: Record<BotLanguage, AudioCommandCopy> = {
    fr: {
        ...
        emptyQueue: "Vous ne savez pas quoi lancer ? Essayez une ambiance prête avec /playlist.",
        ...
        controls: {
            guildMismatch: "Ce contrôle ne correspond pas a ce serveur.",
            playerNotReady: "Le player audio n'est pas prêt.",
            removeForbidden: "Seule la personne qui à ajouté cette musique peut la retirer de la file.",
            ...
            noNextTrack: "Vous ne savez pas quoi lancer ? Essayez une ambiance prête avec /playlist.",
            leaveSuccess: "J'ai quitté le salon vocal et vidé l'état audio.",
        },
        session: {
            emptyDisconnect: "Je me déconnecte car il n'y a plus rien à jouer.",
            voiceDisconnectedTitle: "Session musique terminée",
            voiceDisconnectedDescription: "J'ai été retiré du salon vocal. La session musique à été arrêtée et l'état audio à été réinitialisé.",
        },
        playlist: {
            title: name => `Playlist: ${name}`,
            description: availableSlots => `Selectionnez les titres à ajouter à la queue. Places disponibles: **${availableSlots}**.`,
            truncated: hiddenCount => `${hiddenCount} titre(s) supplémentaire(s) ne sont pas affichés à cause de la limite Discord.`,
            placeholder: "Titres à ajouter",
            serverOnly: "Cette commande doit etre utilisée dans un serveur.",
            guildMismatch: "Ce menu ne correspond pas à ce serveur.",
            ownerOnly: "Seule la personne qui a lancé la commande peut utiliser ce menu.",
            ...
            playerNotReady: "Le player audio n'est pas prêt.",
            noSelection: "Aucun titre selectionné.",
            addFailed: "Impossible d'ajouter ces titres pour le moment.",
            added: count => `${count} titre(s) ajouté(s) a la queue.`,
        ...
        voice: {
            ...
            joinBotVoiceForControl: "Rejoignez mon salon vocal avant d'utiliser ce contrôle.",
            ...
            mustBeInBotVoiceForControl: "Vous devez être dans mon salon vocal pour utiliser ce contrôle.",
        },
        errors: {
